...
THEN my user credentials are saved and I am logged into the site - DONE again..
...
THEN I am presented with the post title, contents, post creator’s username, and date created for that post and have the option to leave a comment - need option to leave comment.
...
THEN I am prompted to enter both a title and contents for my blog post -DONE -add css trickery later.
